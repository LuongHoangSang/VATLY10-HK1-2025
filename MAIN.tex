...
%%%	CHƯƠNG 1: MỞ ĐẦU
<<<<<<< Updated upstream
	\input{data17/G10Y25B1}	% Hạnh
%	\input{data17/G10Y25B2}	% Giau
%	\input{data17/FINAL-CHAPTER1}	% Uyên
%%% CHƯƠNG 2: MÔ TẢ CHUYỂN ĐỘNG 
%	\input{data17/G10Y25B3} % Sang

=======
%	\input{data17/G10Y25B1}\newpage	% HẠNH (3t)
%	\input{data17/G10Y25B2}\newpage	% GIÀU (3t)
%	\input{data17/FINAL-CHAPTER1}\newpage	% UYÊN (2t)
%%% CHƯƠNG 2: MÔ TẢ CHUYỂN ĐỘNG
%	\input{data17/G10Y25B3} % SANG (4t)
	\input{data17/G10Y25B4} % SANG(2t)
%	\input{data17/G10Y25B5} % Giàu (2t)
%%% CHƯƠNG 3: CHUYỂN ĐỘNG BIẾN ĐỔI
%	\input{data17/G10Y25B6} % Uyên (4t)
%	\input{data17/G10Y25B7} % HẠNH (1t)
>>>>>>> Stashed changes
\end{document}
